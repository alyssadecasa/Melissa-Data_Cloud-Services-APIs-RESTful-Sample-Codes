...
# Personator Search API C# REST Sample Code

This is a sample code for Melissa's Personator Search API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Personator Search Web Service and how to call the service in C#. 
...
No installation is necessary for this sample project. Simply open the PersonatorSearch-NET-REST.sln file in your Visual Studio.
