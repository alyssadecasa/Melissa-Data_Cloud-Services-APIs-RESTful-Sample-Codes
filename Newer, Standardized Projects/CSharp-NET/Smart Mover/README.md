...
# Smart Mover API C# REST Sample Code

This is a sample code for Melissa's Smart Mover API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Smart Mover Web Service and how to call the service in C#. 
...
No installation is necessary for this sample project. Simply open the SmartMover-NET-REST.sln file in your Visual Studio.
