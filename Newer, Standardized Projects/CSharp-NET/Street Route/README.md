...
# Street Route Locator API C# REST Sample Code

This is a sample code for Melissa's Street Route Locator API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Street Route Locator Web Service and how to call the service in C#. 
...
No installation is necessary for this sample project. Simply open the StreetRoute-NET-REST.sln file in your Visual Studio.
...
To subscribe to the Street Route Locator Web Service, please contact our sales department at 800-MELISSA ext. 3 (800-635-4772 ext. 3).
...
Street Route Locator Web Service is a trademark and 1-800-MELISSA is a registered trademark
