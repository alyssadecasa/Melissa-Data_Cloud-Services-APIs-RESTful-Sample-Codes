...
# Global Name API HTML/JavaScript REST Sample Code

This is a sample code for Melissa's Global Name API. It is written in HTML and JavaScript and accesses the API through REST. 
This sample is intended to show the functionality of the Global Name Web Service and how to call the service in HTML/JavaScript. 
...
No installation is necessary for this sample project. Simply open the GlobalNameDemo.html file in your browser to run. 
