...
# Personator World API HTML/JavaScript REST Sample Code

This is a sample code for Melissa's Personator World API. It is written in HTML and JavaScript and accesses the API through REST. 
This sample is intended to show the functionality of the Personator World Web Service and how to call the service in HTML/JavaScript. 
...
No installation is necessary for this sample project. Simply open the PersonatorWorldDemo.html file in your browser to run. 
