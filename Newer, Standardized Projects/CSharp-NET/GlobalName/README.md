...
# GlobalName API C# REST Sample Code

This is a sample code for Melissa's Global Name API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Global Name Web Service and how to call the service in C#. 
...
GlobalName Web Service is a trademark and 1-800-MELISSA is a registered trademark
