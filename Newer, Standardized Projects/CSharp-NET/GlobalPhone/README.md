...
# GlobalPhone API C# REST Sample Code

This is a sample code for Melissa's Global Phone API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Global Phone Web Service and how to call the service in C#. 
...
No installation is necessary for this sample project. Simply open the BusinessSearchSample.sln file in your Visual Studio.
...
GlobalPhone Web Service is a trademark and 1-800-MELISSA is a registered trademark
