...
This is a sample code for Melissa's Global Address Verification API. It is written in C# and accesses the API through REST. 
This sample is intended to show the functionality of the Global Address Verification Web Service and how to call the service in C#. 
...
No installation is necessary for this sample project. Simply open the GlobalAddress-NET-REST.sln file in your Visual Studio.
