...
# Personator Search API HTML/JavaScript REST Sample Code

This is a sample code for Melissa's Personator Search API. It is written in HTML and JavaScript and accesses the API through REST. 
This sample is intended to show the functionality of the Personator Search Web Service and how to call the service in HTML/JavaScript. 
...
No installation is necessary for this sample project. Simply open the PersonatorSearchDemo.html file in your browser to run. 
...
To subscribe to the Personator Search Web Service, please contact our sales department at 800-MELISSA ext. 3 (800-635-4772 ext. 3).
...
Personator Search Web Service is a trademark and 1-800-MELISSA is a registered trademark
